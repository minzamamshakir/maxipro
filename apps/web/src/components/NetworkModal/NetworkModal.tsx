...
// AINZICS TODO
import { SUPPORT_ONLY_CORE } from '../../config/constants/supportChains'
...
export const NetworkModal = ({ pageSupportedChains = SUPPORT_ONLY_CORE }: { pageSupportedChains?: number[] }) => {
  ...
  if (isPageNotSupported && isCoreOnlyPage) {
    return (
